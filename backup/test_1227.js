    ...
    async function asyncMain_patient(study_id, query_id) {
        ...
        try{
           ...
           //console.log(study_id, query_id);
            ...
            util_console_print({"1.상태 업데이트": result});            // {resunt:{provider_id:provider_id}}); sql.close();    
            ...
            console.log("----4번시작");
            console.log({result:result})
            var result_3 = make_query_insert_1(result,study_id, query_id, provider_id);     //     {resunt:{result_3:result_3}}); // sql.close();  
    ...
    async function asyncMain(study_id, query_id) {
        try{
           ...
           //console.log(study_id, query_id);
            ...
            pool =  await sql.connect(dbConfig); //scrn_cloud
            console.log("----4번시작");
            var result_3 = make_query_insert_1(result,study_id, query_id, provider_id);     //    
